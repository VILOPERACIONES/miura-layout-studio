  ...
  return (
    <section className="w-full h-[539px] overflow-hidden relative bg-white max-md:h-[400px] max-sm:h-[600px]">
      ...
      <div className="flex w-[469px] flex-col items-start gap-[26px] absolute h-[212px] left-[872px] top-[164px] max-md:w-[350px] max-md:left-[600px] max-md:top-[100px] max-sm:w-80 max-sm:left-5 max-sm:top-[280px]">
        <h2 className="h-[66px] self-stretch text-[#12181D] text-[32px] font-bold max-md:text-[28px] max-sm:text-2xl max-sm:text-center">
          ¿Quienes
          <br />
          SOMOS?
        </h2>
        
        <p className="h-[120px] self-stretch text-black text-justify text-base font-normal leading-[18px] max-md:text-sm max-md:leading-4 max-sm:text-xs max-sm:leading-[14px] max-sm:text-center">
